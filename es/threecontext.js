...
class ThreeContext extends EventManager {
  ...
  constructor(div = null, options) {
    ...
    // init camera
    this._camera = new PerspectiveCamera(27, div.clientWidth / div.clientHeight, 1, 50000);
    ...
    // adding some light
    this._ambiantLight = new AmbientLight(0x444444);
    ...
    this._axesHelper = new AxesHelper( getOption(options, 'axisHelperSize', 100) );
